...
            type:'dotted'
        ...
        return {
          ...
          chartData: {
            columns: ['日期', '当前月份', '选择同期'],
            rows: [
              { '日期': '1-1', '当前月份': 1393, '选择同期': 1093},
              { '日期': '1-2', '当前月份': 3530, '选择同期': 3230},
              { '日期': '1-3', '当前月份': 2923, '选择同期': 2623},
              { '日期': '1-4', '当前月份': 1723, '选择同期': 1423},
              { '日期': '1-5', '当前月份': 3792, '选择同期': ''},
              { '日期': '1-6', '当前月份': 4593, '选择同期': ''}
            ]
          },
          commodityValue:"选项1",
          commodityOptions:[{
