  ...
  data () {
    return {
      ...
      drawerTopAreaOption:[
        ...
        {title:"前处理车间",width: "60px",height:"17%",top:"43%",left:"58%",marginLeft:"50px",hasElectric:true,hasWater:true,hasSteam:true},
      ...
      drawerBottomAreaOption:[
        ...
        {title:"办公楼＼食堂",width: "360px",height:"48%",top:"10%",left:"25%",marginLeft:"20px",hasElectric:true,hasWater:true,hasSteam:true},
      ],
