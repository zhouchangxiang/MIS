    ...
    while True:
        ...
        try:
            ...
            stekeys = db_session.query(SteamEnergy).filter(SteamEnergy.IncrementFlag == "0",
                                                           SteamEnergy.SumValue != "0.0").order_by(desc("CollectionDate")).limit(100).all()
            for key in stekeys:
            ...
            steam_IDS = list()
            steamInitial = list()
            upstekeys = db_session.query(IncrementStreamTable).filter(IncrementStreamTable.insertFlag == "0").order_by(desc("CollectionDate")).limit(100).all()
            ...
            upsteVkeys = db_session.query(IncrementStreamVolume).filter(
                IncrementStreamVolume.insertFlag == "0").order_by(desc("CollectionDate")).limit(100).all()
            ...
            elekeys = db_session.query(ElectricEnergy).filter(ElectricEnergy.IncrementFlag == "0",
                                                              ElectricEnergy.ZGL != "0.0").order_by(desc("CollectionDate")).limit(100).all()
            for key in elekeys:
            ...
            upeleskeys = db_session.query(IncrementElectricTable).filter(
                IncrementElectricTable.insertFlag == "0").order_by(desc("CollectionDate")).limit(100).all()
            ...
            elekeys = db_session.query(WaterEnergy).filter(WaterEnergy.IncrementFlag == "0",
                                                           WaterEnergy.WaterSum != "0.0").order_by(desc("CollectionDate")).limit(100).all()
            for key in elekeys:
